...
public class fleet_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VehicleDB cdb = new VehicleDB(fleet_activity.this);
        ArrayList<HashMap<String, String> > table_data = cdb.getvehicles("Vtype","Ship");
